...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--out-csv",
        type=Path,
        default=Path("ml_workspace/data_driven/output/segments/plane_166_phase_segments.csv"),
        help="Output CSV for segmented phases.",
    )
    parser.add_argument(
        "--issues-csv",
        type=Path,
        default=Path("ml_workspace/data_driven/output/segments/plane_166_segmentation_issues.csv"),
        help="Output CSV for segmentation issues.",
    )
    parser.add_argument(
        "--summary-csv",
        type=Path,
        default=Path("ml_workspace/data_driven/output/segments/plane_166_segmentation_summary.csv"),
